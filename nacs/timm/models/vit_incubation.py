...
@register_model
def vit_incub_huge(pretrained=False, **kwargs):
    model = ViTIncub(patch_size=14, embed_dim=1280, depth=32, num_heads=16, mlp_ratio=4, **kwargs)
