...
from deep_incubation.main import main


def get_args_parser():
    parser = argparse.ArgumentParser('Modified DeiT training script for m2mKD', add_help=False)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Modified DeiT training script for m2mKD', parents=[get_args_parser()])
